...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getCategoriesM = function (type) {
        return this.http.get(this.URL_API + ("/categories/type/" + type));
    };
    CategoryService.prototype.getCategoriesId = function (idCategory) {
        return this.http.get(this.URL_API + "/categories/search", idCategory);
    };
    CategoryService.prototype.registerCategories = function (Category) {
...
var MaterialsService = /** @class */ (function () {
    function MaterialsService(http, config) {
        this.http = http;
        this.config = config;
        this.URL_API = this.config.getConfig().bussinesServer.url;
    }
    MaterialsService.prototype.ngOnInit = function () {
    };
    MaterialsService.prototype.getMaterials = function () {
        return this.http.get(this.URL_API + "/materials");
    };
    MaterialsService.prototype.getSelectedMaterials = function (idvisit) {
        return this.http.get(this.URL_API + ("/materials/selected/" + idvisit.id + "?id_section=" + idvisit.id_section));
    };
    MaterialsService.prototype.getMaterialsId = function (idCategory) {
        return this.http.get(this.URL_API + ("/materials/" + idCategory));
    };
    MaterialsService.prototype.registerMaterials = function (nameMaterial) {
        return this.http.post(this.URL_API + "/materials/create", nameMaterial);
    };
    MaterialsService.prototype.putMaterial = function (material) {
        return this.http.put(this.URL_API + ("/materials/" + material._id), material);
    };
    MaterialsService.prototype.deleteMaterial = function (material) {
        return this.http.delete(this.URL_API + ("/materials/" + material));
    };
    MaterialsService.prototype.searchsMaterials = function (material) {
        return this.http.post(this.URL_API + "/materials/search", material);
    };
    MaterialsService.prototype.upload = function (file) {
...
var UploadService = /** @class */ (function () {
    ...
    UploadService.prototype.SendUri = function (nameUser) {
...
/***/ "./src/app/services/workforce.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/workforce.service.ts ***!
  \***********************************************/
/*! exports provided: WorkforceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkforceService", function() { return WorkforceService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var WorkforceService = /** @class */ (function () {
    function WorkforceService(http, config) {
        this.http = http;
        this.config = config;
        this.URL_API = this.config.getConfig().bussinesServer.url;
    }
    WorkforceService.prototype.ngOnInit = function () {
    };
    WorkforceService.prototype.getWorkforce = function () {
        return this.http.get(this.URL_API + "/workforce");
    };
    WorkforceService.prototype.getWorkForceId = function (idCategory) {
        return this.http.get(this.URL_API + ("/workforce/" + idCategory));
    };
    WorkforceService.prototype.getSelectedWorkforce = function (idvisit) {
        return this.http.get(this.URL_API + "/workforce/selected" + ("/" + idvisit));
    };
    WorkforceService.prototype.register = function (workf) {
        return this.http.post(this.URL_API + "/workforce", workf);
    };
    WorkforceService.prototype.put = function (workf) {
        return this.http.put(this.URL_API + ("/workforce/" + workf.id), workf);
    };
    WorkforceService.prototype.delete = function (_id) {
        return this.http.delete(this.URL_API + ("/workforce/" + _id));
    };
    WorkforceService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
